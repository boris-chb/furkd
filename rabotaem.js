...
let questionnaire_ = {
  setAnswers(answers) {
    // BUG TEMPORARY FIX labellingGraph.ph
    ...
    if (
      !dom_.questionnaire.labellingGraph.ph ||
      dom_.questionnaire.labellingGraph.ph.size === 0
    ) {
      throw new Error(
    ...
    return dom_.questionnaire.labellingGraph.ph;
  },
