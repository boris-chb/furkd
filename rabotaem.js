...
let questionnaire_ = {
  setAnswers(answers) {
    // BUG TEMPORARY FIX labellingGraph.bh
    ...
    if (
      !dom_.questionnaire.labellingGraph.bh ||
      dom_.questionnaire.labellingGraph.bh.size === 0
    ) {
      throw new Error(
    ...
    return dom_.questionnaire.labellingGraph.bh;
  },
