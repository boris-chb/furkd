...
let questionnaire_ = {
  setAnswers(answers) {
    // BUG TEMPORARY FIX labellingGraph.bg
    ...
    if (
      !dom_.questionnaire.labellingGraph.bg ||
      dom_.questionnaire.labellingGraph.bg.size === 0
    ) {
      throw new Error(
    ...
    return dom_.questionnaire.labellingGraph.bg;
  },
