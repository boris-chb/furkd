...
let questionnaire_ = {
  setAnswers(answers) {
    // BUG TEMPORARY FIX labellingGraph.ne
    ...
    if (
      !dom_.questionnaire.labellingGraph.ne ||
      dom_.questionnaire.labellingGraph.ne.size === 0
    ) {
      throw new Error(
    ...
    return dom_.questionnaire.labellingGraph.ne;
  },
