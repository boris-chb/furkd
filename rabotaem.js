...
let questionnaire_ = {
  setAnswers(answers) {
    // BUG TEMPORARY FIX labellingGraph.te
    ...
    if (
      !dom_.questionnaire.labellingGraph.te ||
      dom_.questionnaire.labellingGraph.te.size === 0
    ) {
      throw new Error(
    ...
    return dom_.questionnaire.labellingGraph.te;
  },
