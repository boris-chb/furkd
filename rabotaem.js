...
let questionnaire_ = {
  setAnswers(answers) {
    // BUG TEMPORARY FIX labellingGraph.rg
    ...
    if (
      !dom_.questionnaire.labellingGraph.rg ||
      dom_.questionnaire.labellingGraph.rg.size === 0
    ) {
      throw new Error(
    ...
    return dom_.questionnaire.labellingGraph.rg;
  },
