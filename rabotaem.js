...
let questionnaire_ = {
  setAnswers(answers) {
    // BUG TEMPORARY FIX labellingGraph.pe
    ...
    if (
      !dom_.questionnaire.labellingGraph.pe ||
      dom_.questionnaire.labellingGraph.pe.size === 0
    ) {
      throw new Error(
    ...
    return dom_.questionnaire.labellingGraph.pe;
  },
