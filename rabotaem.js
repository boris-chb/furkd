...
let config_ = {
  ...
  USE_KEYPRESS: false,
  showLogs: true,
  FUNCTION_CALL_RETRY_INTERVAL_MS: 50,
...
let questionnaire_ = {
  setAnswers(answers) {
    // BUG TEMPORARY FIX labellingGraph.pf
    ...
    if (
      !dom_.questionnaire.labellingGraph.pf ||
      dom_.questionnaire.labellingGraph.pf.size === 0
    ) {
      throw new Error(
    ...
    return dom_.questionnaire.labellingGraph.pf;
  },
