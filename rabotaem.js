...
let questionnaire_ = {
  setAnswers(answers) {
    // BUG TEMPORARY FIX labellingGraph.se
    ...
    if (
      !dom_.questionnaire.labellingGraph.se ||
      dom_.questionnaire.labellingGraph.se.size === 0
    ) {
      throw new Error(
    ...
    return dom_.questionnaire.labellingGraph.se;
  },
